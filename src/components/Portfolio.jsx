...
import { 
  ...
  Code, User, Briefcase, ChevronRight 
} from 'lucide-react';
...
export default function Portfolio({ data }) {
  const profile = data || {
    ...
    bio: "I build scalable web applications with modern technologies. Passionate about clean code and user experience.",
    contact: { email: "hello@kamal.com", linkedin: "#", github: "#" },
    skills: ["React", "Node.js", "Tailwind CSS", "JavaScript", "MongoDB"],
    projects: [
      { name: "E-Commerce App", description: "A fully functional online store with payment integration.", techStack: "MERN Stack" },
      { name: "Task Manager", description: "Productivity tool to manage daily tasks efficiently.", techStack: "React & Firebase" }
    ]
  };
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-center justify-center md:justify-start gap-4 pt-4">
            ...
            <div className="flex items-center gap-3 ml-4">
              <a href={profile.contact.github} className="p-3 bg-gray-100 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 transition-all"><Github size={22}/></a>
              <a href={profile.contact.linkedin} className="p-3 bg-gray-100 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 transition-all"><Linkedin size={22}/></a>
            </div>
          </div>
        </div>
      </header>
